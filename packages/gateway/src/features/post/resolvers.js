...
const createPostObjectResolver = isAuthenticatedResolver.createResolver(
  (_, vars, ctx) => ctx.models.post.createObject(vars),
);

const deletePostObjectResolver = isAuthenticatedResolver.createResolver(
  (_, vars, ctx) => ctx.models.post.deleteObject(vars),
);

const updatePostObjectResolver = isAuthenticatedResolver.createResolver(
  (_, vars, ctx) => ctx.models.post.updateObject(vars),
);
