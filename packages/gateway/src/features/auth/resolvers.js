...
export const isAuthenticatedResolver = baseResolver.createResolver((_, __, { user }) => {
...
const authenticateResolver = isAuthenticatedResolver.createResolver((_, vars, ctx) =>
	ctx.models.auth.authenticate(vars),
);

const deauthenticateResolver = isAuthenticatedResolver.createResolver((_, __, ctx) =>
	ctx.models.auth.deauthenticate(),
);
